...
"""
This program manages a container system where users can loot items into a container or a multi container. 
...
print(f'Initialised {len(item_list) + len(container_list) + len(multi_containers_instances_list)} items including {len(container_list) + len(multi_containers_instances_list)} containers.\n')
